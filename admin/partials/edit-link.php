...
<div class="wrap tlp-wrap">
    <h1><?php _e('Edit Temporary Login Link', 'temporary-login-links-premium'); ?></h1>
    ...
    <div class="tlp-form-page">
        <form method="post" action="" id="tlp-edit-link-form">
            ...
            <div class="tlp-view-link-url">
                <p><strong><?php _e('Login URL:', 'temporary-login-links-premium'); ?></strong></p>
            ...
            <table class="tlp-form-table">
                <tbody>
                    ...
                    <tr>
                        <th>
                            <label for="user_email"><?php _e('Email Address', 'temporary-login-links-premium'); ?></label>
                        </th>
                        <td>
                            ...
                            <p class="description"><?php _e('The email address cannot be changed. To use a different email, create a new link.', 'temporary-login-links-premium'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e('The role assigned to the temporary user.', 'temporary-login-links-premium'); ?></p>
                    ...
                    <tr>
                        <th>
                            <label for="is_active"><?php _e('Status', 'temporary-login-links-premium'); ?></label>
                        </th>
                        <td>
                            <label>
                                <input type="checkbox" name="is_active" id="is_active" value="1" <?php checked($form_data['is_active'], 1); ?>>
                                <?php _e('Active', 'temporary-login-links-premium'); ?>
                            </label>
                            <p class="description"><?php _e('If unchecked, the link will be deactivated and cannot be used for login.', 'temporary-login-links-premium'); ?></p>
                        </td>
                    </tr>
            ...
            <div class="tlp-form-actions">
                <button type="submit" class="button button-primary"><?php _e('Update Login Link', 'temporary-login-links-premium'); ?></button>
                <a href="<?php echo esc_url(admin_url('admin.php?page=temporary-login-links-premium-links&action=view&id=' . $link_id)); ?>" class="button button-secondary"><?php _e('Cancel', 'temporary-login-links-premium'); ?></a>
            </div>
        </form>
    </div>
    ...
    <div class="tlp-sidebar">
        <div class="tlp-sidebar-box">
            <h3><?php _e('Link Access Statistics', 'temporary-login-links-premium'); ?></h3>
            
            <div class="tlp-stats">
                <div class="tlp-stat-item">
                    <span class="tlp-stat-label"><?php _e('Created:', 'temporary-login-links-premium'); ?></span>
                ...
                <div class="tlp-stat-item">
                    <span class="tlp-stat-label"><?php _e('Current Expiry:', 'temporary-login-links-premium'); ?></span>
                    <span class="tlp-stat-value"><?php echo date_i18n(get_option('date_format') . ' ' . get_option('time_format'), strtotime($link['expiry'])); ?></span>
                </div>
                
                <div class="tlp-stat-item">
                    <span class="tlp-stat-label"><?php _e('Access Count:', 'temporary-login-links-premium'); ?></span>
                    <span class="tlp-stat-value"><?php echo $link['access_count']; ?><?php echo $link['max_accesses'] > 0 ? ' / ' . $link['max_accesses'] : ''; ?></span>
                </div>
                
                <div class="tlp-stat-item">
                    <span class="tlp-stat-label"><?php _e('Last Accessed:', 'temporary-login-links-premium'); ?></span>
                ...
                <div class="tlp-stat-item">
                    <span class="tlp-stat-label"><?php _e('Current Status:', 'temporary-login-links-premium'); ?></span>
                    <span class="tlp-stat-value">
                        <?php
                        if ($link['is_active'] == 0) {
            ...
            <div class="tlp-sidebar-actions">
                <a href="<?php echo esc_url(admin_url('admin.php?page=temporary-login-links-premium-links&action=view&id=' . $link_id)); ?>" class="button"><?php _e('View Full Details', 'temporary-login-links-premium'); ?></a>
            </div>
        </div>
        ...
        <div class="tlp-sidebar-box">
            ...
            <div class="tlp-tips">
                ...
                <div class="tlp-tip">
                    ...
                    <div class="tlp-tip-content">
                        <h4><?php _e('Custom Expiry', 'temporary-login-links-premium'); ?></h4>
                        <p><?php _e('Use the custom expiry option to set a specific date and time for the link to expire.', 'temporary-login-links-premium'); ?></p>
                    </div>
                </div>
            </div>
        </div>
